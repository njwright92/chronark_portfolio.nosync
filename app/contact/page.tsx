	...
	return (
		<div className="bg-zinc-900">
			...
			<div className="container flex flex-col items-center justify-center min-h-screen px-4 mx-auto pt-20">
				...
				<div className="grid w-full grid-cols-1 gap-8 mt-32 sm:mt-0 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 auto-rows-fr lg:gap-16">
					{socials.map((s) => (
						<Card key={s.handle}>
							...
							>
								{/* Icon and Labels */}
								<span className="relative flex items-center justify-center w-12 h-12 text-sm duration-1000 border rounded-full text-zinc-300 group-hover:text-peachFuzz group-hover:bg-zinc-800 border-zinc-300 bg-zinc-900">
									{s.icon}
								</span>
								<div className="flex flex-col items-center">
									<span className="lg:text-xl font-sm duration-150 xl:text-2xl text-zinc-300 group-hover:text-peachFuzz font-display">
										{s.handle}
									</span>
									<span className="mt-4 text-sm text-center duration-1000 text-peachFuzz group-hover:text-white">
										{s.label}
									</span>
								</div>
							</Link>
				...
				<div className="text-center border border-peachFuzz/30 rounded-xl shadow-md p-6 mt-6 mb-6 overflow-hidden relative duration-700 group hover:bg-zinc-800/10">
					...
					<button
						onClick={openModal}
						className="mt-4 bg-zinc-900 text-zinc-300 shadow-md rounded-xl px-4 py-2 border border-peachFuzz/30"
					>
